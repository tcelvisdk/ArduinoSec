...
{ int toBeReturned = 0;
  ...
  while (keepLooping)
  {
    ...
    {
      Serial.print ("Something read: ");
      Serial.println(results.value, HEX);
      Serial.print("keepLooping ");
      Serial.println(keepLooping);
      ...
      {
        Serial.println("keepLooping change");
        keepLooping = false;
      }
    }
  }
  ...
  Serial.println(toBeReturned);
  int xx = toBeReturned - ((toBeReturned / (10 * digits)) * (10 * digits));
